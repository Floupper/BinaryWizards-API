...
app.post('/game/:game_id/start', validateGameId, gamesHandler.start_one); // Start the game
...
app.get('/game/:game_id/join', validateGameId, checkAuthentication, gamesHandler.join_game);
